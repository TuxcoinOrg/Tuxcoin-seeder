...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Garlicoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.rshaw.space", ""};
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    //db.Add(CService("kjy2eqzk4zwi5zd3.onion", 42069), true);
    db.Add(CService("178.62.112.59", 42069), true);
  }
  do {
